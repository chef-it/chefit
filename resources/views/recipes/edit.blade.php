        ...
        <div class="col-md-8 col-md-offset-2">
            <div class="panel panel-grey">
                <div class="panel-heading">
                    <h3 class="panel-title">Edit {{ $recipe->name }}</h3>
                </div>
                <div class="panel-body">
                    ...
                    <div class="row">
                        ...
                        <div class="form-group col-md-6">
                            ...
                            {{ Form::text('batch_quantity', null, array('class' => 'form-control', 'autocomplete' => 'off')) }}
                    ...
                    <div class="row">
                        <div class="form-group col-md-6">
                            ...
                            <div class="input-group">
                                ...
                                {{ Form::text('menu_price', null, array('class' => 'form-control', 'autocomplete' => 'off')) }}
                            </div>
                        </div>
                        <div class="form-group col-md-3">
                            {{ Form::label('portions_per_batch', 'Portions per Batch: ') }}
                            {{ Form::text('portions_per_batch', null, array('class' => 'form-control', 'required' => 'required', 'autocomplete' => 'off')) }}
                        </div>
                        <div class="form-group col-md-3">
                            {{ Form::label('component_only', 'Sub Recipe Only: ') }}
                            {{ Form::select('component_only', $options, $recipe->component_only, array('class' => 'form-control', 'required' => 'required')) }}
                        </div>
                    </div>
